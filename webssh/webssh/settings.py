...
from webssh.policy import (check_policy_setting, get_policy_class,
                           load_host_keys)
from webssh.utils import (is_valid_encoding, parse_origin_from_url,
                          to_ip_address)
...
def get_origin_setting(options):
    if options.debug or (options.origin == "*"):
        return "*"
